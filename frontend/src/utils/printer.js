export function printTicket(printWindow, cart, total, saleId = "OFFLINE") {
  const now = new Date();
...
Gracias por su compra!
  ...
  // Le damos un respiro para que renderice el HTML y lanzamos la impresión
  setTimeout(() => {
    printWindow.focus();
    printWindow.print();
  }, 250);
...
export const printInvoice = (printWindow, cart, total, customerName, customerDocument, paymentType, saleId) => {
